...
The Highdarts header shows played, live and paused match counts, ongoing pairings with leg scores, and an expandable finished-games list. Names link to profiles, active statuses open spectator view, and completed app matches link to their reports. Reported results retain their source label. Early-ended games appear in history but do not count as played. Status refreshes with the existing snapshot every 15 seconds and on window focus.
