...
| `games/BoardPicker.tsx` | New-game board dropdown, live status labels, and location-to-board matching; `BoardPicker.test.ts` covers matching when a board is offline or absent |
