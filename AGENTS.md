...
| `match/[id]/report/page.tsx` | Server-rendered DartIQ Match Pulse, deterministic match story, player baseline/WPA breakdowns, and URL-selected dart synchronization with ranked swings/Scolia heatmaps |
