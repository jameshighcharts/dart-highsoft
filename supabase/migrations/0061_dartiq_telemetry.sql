...
create table public.dartiq_projection_events (
  ...
  leg_opportunity double precision check (leg_opportunity between 0 and 1),
  match_opportunity double precision check (match_opportunity between 0 and 1),
  leg_directional_tail double precision check (leg_directional_tail between 0 and 1),
  match_directional_tail double precision check (match_directional_tail between 0 and 1),
  leg_consequence_tail double precision check (leg_consequence_tail between 0 and 1),
  match_consequence_tail double precision check (match_consequence_tail between 0 and 1),
  rarity_commentary_eligible boolean not null default false,
  outcome_exact_state_samples integer not null default 0 check (outcome_exact_state_samples >= 0),
...
begin
  ...
  with inserted_events as (
    insert into public.dartiq_projection_events (
      ...
      leg_opportunity,
      match_opportunity,
      leg_directional_tail,
      match_directional_tail,
      leg_consequence_tail,
      match_consequence_tail,
      rarity_commentary_eligible,
      outcome_exact_state_samples,
      actual_score_delta,
      actual_is_double,
      busted,
      actual_outcome,
    ...
    select
      ...
      event_row.leg_opportunity,
      event_row.match_opportunity,
      event_row.leg_directional_tail,
      event_row.match_directional_tail,
      event_row.leg_consequence_tail,
      event_row.match_consequence_tail,
      coalesce(event_row.rarity_commentary_eligible, false),
      coalesce(event_row.outcome_exact_state_samples, 0),
...
begin
  ...
  insert into public.dartiq_projection_events (
    ...
    v_event.leg_opportunity,
    v_event.match_opportunity,
    v_event.leg_directional_tail,
    v_event.match_directional_tail,
    v_event.leg_consequence_tail,
    v_event.match_consequence_tail,
    coalesce(v_event.rarity_commentary_eligible, false),
    coalesce(v_event.outcome_exact_state_samples, 0),
