...
export function applyThrowChange(
  ...
  if (payload.eventType === 'DELETE') {
    ...
    const nextThrow: ThrowRecord = {
      ...
      impact_x_mm: record.impact_x_mm !== undefined ? record.impact_x_mm : throws[existingIndex]?.impact_x_mm ?? null,
      impact_y_mm: record.impact_y_mm !== undefined ? record.impact_y_mm : throws[existingIndex]?.impact_y_mm ?? null,
      angle_horizontal_deg: record.angle_horizontal_deg !== undefined ? record.angle_horizontal_deg : throws[existingIndex]?.angle_horizontal_deg ?? null,
      angle_vertical_deg: record.angle_vertical_deg !== undefined ? record.angle_vertical_deg : throws[existingIndex]?.angle_vertical_deg ?? null,
    };
    if (existingIndex >= 0) {
